...
export 'list_members_model.dart';

class ListMembersWidget extends StatefulWidget {
  const ListMembersWidget({Key? key}) : super(key: key);

  @override
  _ListMembersWidgetState createState() => _ListMembersWidgetState();
}

class _ListMembersWidgetState extends State<ListMembersWidget> {
  late ListMembersModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ListMembersModel());
                                          ...
                                          Padding(
                                            padding:
                                                EdgeInsetsDirectional.fromSTEB(
                                                    0.0, 4.0, 0.0, 0.0),
                                            child: Text(
                                              'Joined ${getCurrentTimestamp.toString()}',
                                              style:
